...
if ('list' == $op) {
    ...
    $form->addElement(new XoopsFormText(_AM_URL, 'headline_url', 50, 255, 'https://'), true);

    // --- rssurl ---
    //  $form->addElement(new XoopsFormText(_AM_URLEDFXML, 'headline_rssurl', 50, 255, 'https://'), true);

    $form->addElement(new XoopsFormText(_AM_URLEDFXML, 'headline_rssurl', 50, 255, 'https://'), false);
    // ---
